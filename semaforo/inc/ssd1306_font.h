...
static uint8_t font[] = {
    ...
    // Glifo para "ç" (cedilha)
    0x3C, 0x42, 0x42, 0x42, 0x42, 0x42, 0x3C, 0x06,  // ç

    // Glifo para "ã" (til)
    0x3C, 0x42, 0x42, 0x42, 0x42, 0x46, 0x3C, 0x00,  // ã

    // Novo glifo para o dígito 2 – Linha Vertical
    0x08, 0x08, 0x08, 0x08, 0x08, 0x08, 0x08, 0x08, // 2

    // Novo glifo para o dígito 3 – Interseção (Cruz)
    0x08, 0x08, 0x08, 0xFF, 0x08, 0x08, 0x08, 0x08, // 3
